...
BIRMINGHAM_COORDINATES = { "latitude": 52.4862, "longitude": -0.8904 }

# Calculate movement increments
LATITUDE_INCREMENT = (BIRMINGHAM_COORDINATES["latitude"] - LONDON_COORDINATES["latitude"]) / 100.0
LONGITUDE_INCREMENT = (BIRMINGHAM_COORDINATES["longitude"] - LONDON_COORDINATES["longitude"]) / 100.0
...
def simulate_journey(producer, device_id):
    while True:
        ...
        traffic_camera_data = generate_traffic_camera_data(device_id, vehicle_data["timestamp"], vehicle_data["location"],camera_id='Sonyalpha')
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer, "Vehicle-Ns-45")
